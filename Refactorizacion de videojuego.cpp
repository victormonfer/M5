...
bool checkEnemyStatus(int& enemyHP, string enemyName) {
    if (enemyHP <= 0) {
...
void enemyAttack(int damage, int& heroHP, string enemyName, bool& heroIsAlive) {
